...
class EnvParams:
    ...
    def __init__(self, attack_time=0.1, decay_time=0.01, release_time=0.2,
                 attack_level=1.0, sustain_level=1.0):  # fmt: skip
...
class Patch:
    ...
    def __init__(
        self,
        name="initpatch",
        wave_type=WaveType.OSC,
        wave="SAW",
        detune=1.01,
        filt_type="LP",
        filt_f=4000,
        filt_q=0.7,
        filt_env_params=None,
        amp_env_params=None,
    ):
        """
    ...
    def set_by_wave_select(self, wave_select):
        ...
        # wave contains wavetable filename if wave_type is 'wtb'
        self.wave, *waveB = oscs.split("/")
